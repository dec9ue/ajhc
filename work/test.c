char jhc_c_compile[] = "gcc /tmp/jhc_PCjqEf/rts/profile.c /tmp/jhc_PCjqEf/rts/rts_support.c /tmp/jhc_PCjqEf/rts/gc_none.c /tmp/jhc_PCjqEf/rts/jhc_rts.c /tmp/jhc_PCjqEf/lib/lib_cbits.c /tmp/jhc_PCjqEf/rts/gc_jgc.c /tmp/jhc_PCjqEf/rts/stableptr.c -I/tmp/jhc_PCjqEf/cbits -I/tmp/jhc_PCjqEf test.c -o test.c '-std=gnu99' -D_GNU_SOURCE '-falign-functions=4' -ffast-math -Wextra -Wall -Wno-unused-parameter -fno-strict-aliasing -DNDEBUG -O3 '-D_JHC_GC=_JHC_GC_JGC'";
...
static wptr_t fInstance$__iJhc_Show_show_default(gc_t gc,wptr_t v1204427289,sptr_t v1206000155) A_STD A_MALLOC;
...
static wptr_t fJhc_Show_shows(gc_t gc,sptr_t v206123620,sptr_t v206123614) A_STD A_MALLOC;
static wptr_t fJhc_Show_showsPrec(gc_t gc,wptr_t v1462508059,wptr_t v97079480,sptr_t v125289868,sptr_t v194599746) A_STD A_MALLOC;
...
static wptr_t fW$__fJhc_Inst_Show_showWord(gc_t gc,uint32_t v1348607539,sptr_t v1351884333) A_STD A_MALLOC;
...
static wptr_t fW$__fR$__fJhc_List_243__sub(gc_t gc,wptr_t v108606838,uint32_t v131100612) A_STD A_MALLOC;
static void ftheMain(gc_t gc) A_STD;
static uint16_t ftheMain$d2(gc_t gc,sptr_t v177396240,uint32_t v320479265) A_STD;
static wptr_t ftheMain$d3(gc_t gc,sptr_t v340664349,sptr_t v219985668) A_STD A_MALLOC;
static uint16_t ftheMain$d4(gc_t gc,sptr_t v157435254,uint32_t v322576417) A_STD;
static wptr_t ftheMain$d5(gc_t gc,sptr_t v338698271,sptr_t v177396242) A_STD A_MALLOC;
...
/* CAFS */
/* v-999825429 = (FtheMain$8)*/
static node_t _g999825429 = { .head = TO_FPTR(&E__ftheMain$d8) };
#define g999825429 (MKLAZY_C(&_g999825429))

/* v-1001136149 = (FtheMain$7)*/
static node_t _g1001136149 = { .head = TO_FPTR(&E__ftheMain$d7) };
#define g1001136149 (MKLAZY_C(&_g1001136149))
...
&_g999825429, &_g1001136149, &_c1, &_c2, &_c3, &_c4, &_c5, &_c6,
...
static wptr_t A_STD A_MALLOC
fInstance$__iJhc_Show_show_default(gc_t gc,wptr_t v1204427289,sptr_t v1206000155)
{
        return fJhc_Show_showsPrec(gc,v1204427289,PROMOTE(c127),v1206000155,(sptr_t)SET_RAW_TAG(CJhc_Prim_Prim_$BE));
}
...
static wptr_t A_STD A_MALLOC
fJhc_Show_shows(gc_t gc,sptr_t v206123620,sptr_t v206123614)
{
        return fJhc_Show_showsPrec(gc,SET_RAW_TAG(TJhc_Type_Word_Int),PROMOTE(c127),v206123620,v206123614);
}

static wptr_t A_STD A_MALLOC
fJhc_Show_showsPrec(gc_t gc,wptr_t v1462508059,wptr_t v97079480,sptr_t v125289868,sptr_t v194599746)
{
        if (SET_RAW_TAG(TJhc_Type_Word_Int) == v1462508059) {
            uint32_t v108606846;
            ...
            v81659226 = ((struct sTJhc_Prim_Prim_$BE*)v1462508059)->a1;
...
fW$__fJhc_Enum_39__f(gc_t gc,uint32_t v108606840)
{
        ...
        uint16_t v100026 = (((int32_t)40000) < ((int32_t)v108606840));
        if (0 == v100026) {
...
static wptr_t A_STD A_MALLOC
fW$__fJhc_Inst_Show_showWord(gc_t gc,uint32_t v1348607539,sptr_t v1351884333)
{
        sptr_t v69723200;
        uint32_t v264753294;
        v264753294 = v1348607539;
        v69723200 = v1351884333;
            ...
            {   gc_frame0(gc,1,v69723200);
                ...
                if (0 == v46435058) {
                    ...
                    {   gc_frame0(gc,1,v65620012);
                        ...
                        wptr_t v353 = x10;
                        sptr_t v1354767919 = demote(v353);
                        v264753294 = v46435058;
                        v69723200 = v1354767919;
...
static wptr_t A_STD A_MALLOC
fW$__fR$__fJhc_List_243__sub(gc_t gc,wptr_t v108606838,uint32_t v131100612)
{
        sptr_t v108606886;
        uint32_t v131100661;
        sptr_t v108607102 = demote(v108606838);
        v108606886 = v108607102;
        v131100661 = v131100612;
        ...
        {   wptr_t v100038 = eval(gc,v108606886);
            if (SET_RAW_TAG(CJhc_Prim_Prim_$BE) == v100038) {
                ...
                if (0 == v131100661) {
                    ...
                    uint32_t v55080222 = (v131100661 - 1);
                    v108606886 = v405;
                    v131100661 = v55080222;
...
ftheMain(gc_t gc)
{
        wptr_t v100066;
        sptr_t v225;
        v100066 = fInstance$__iJhc_Show_show_default(gc,PROMOTE(c132),g999825429);
...
ftheMain$d2(gc_t gc,sptr_t v177396240,uint32_t v320479265)
{
        uint32_t v101379728;
        wptr_t v100024 = eval(gc,v177396240);
        v101379728 = ((struct sCJhc_Type_Word_Int*)v100024)->a1;
        return ((int32_t)v320479265) < ((int32_t)v101379728);
}

static wptr_t A_STD A_MALLOC
ftheMain$d3(gc_t gc,sptr_t v340664349,sptr_t v219985668)
{
        {   sptr_t v247;
            uint16_t v263598670;
            uint32_t v63014770;
            gc_frame0(gc,1,v340664349);
            wptr_t v100020 = eval(gc,v219985668);
            wptr_t v100022 = promote(v340664349);
...
static uint16_t A_STD
ftheMain$d4(gc_t gc,sptr_t v157435254,uint32_t v322576417)
{
        uint32_t v65615840;
        wptr_t v100018 = eval(gc,v157435254);
        v65615840 = ((struct sCJhc_Type_Word_Int*)v100018)->a1;
        return ((int32_t)v322576417) >= ((int32_t)v65615840);
}

static wptr_t A_STD A_MALLOC
ftheMain$d5(gc_t gc,sptr_t v338698271,sptr_t v177396242)
{
        {   sptr_t v259;
            uint32_t v125052412;
            uint16_t v142055664;
            gc_frame0(gc,1,v338698271);
            wptr_t v100014 = eval(gc,v177396242);
            wptr_t v100016 = promote(v338698271);
...
ftheMain$d7(gc_t gc)
{
        ...
        return fW$__fR$__fJhc_Basics_136__f(gc,39999,v100078);
}

static wptr_t A_STD A_MALLOC
ftheMain$d8(gc_t gc)
{
        return fInstance$__iJhc_Show_show_default(gc,PROMOTE(c133),g1001136149);
}
